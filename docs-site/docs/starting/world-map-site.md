...
For how each biome plays and what a good starting climate looks like, see the [Biomes](https://rimworldwiki.com/wiki/Biomes) article on the RimWorld wiki.
...
For the full set of scanner keys, see [The scanner](../concepts/the-scanner.md).
...
After you settle, you choose who comes with you. See [Creating your colonists](creating-colonists.md).
